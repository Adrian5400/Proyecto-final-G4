...
const Equipo = () => {
  return (
    <div className="mx-auto contenedor container pt-3">
      <h1 className="pt-2 pt-sm-1 mb-1 pb-1 d-none d-sm-block" style={{ textAlign: 'center', color: "var(--color5)" }}>Curso de DAW 2ªA IES Monte Naranco</h1>
      <h2 className="pt-5 pt-sm-1 pt-sm-3 mb-1 pb-1" style={{ textAlign: 'center', color: "var(--color5)" }}>Tecnologías Usadas</h2>
            ...
            <Col key={miembro.nombre}>
              <Card className="my-3 col-xs-12">
                <Card.Body className="d-flex flex-column justify-content-center align-items-center">
                  <Image src={miembro.foto} style={{ height: "25vh", width: "20vh", objectFit: "contain" }} className="mb-3" />
