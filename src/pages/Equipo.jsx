...
const Equipo = () => {
  return (
    <div className="mx-auto contenedor container pt-3" >
      <h1 className="pt-2 mb-1 pb-1" style={{ textAlign: 'center', color: "var(--color5)", fontFamily: 'Verdana, sans-serif' }}>Curso de DAW 2ªA IES Monte Naranco</h1>
          <h2 className="pt-2 mb-1 pb-1" style={{textAlign: 'center', color: "var(--color5)", fontFamily: 'Verdana, sans-serif'}}>Tecnologías Usadas</h2>
          ...
          <Col key={miembro.nombre}>
            <Card className="my-3 col-xs-12">
              <Card.Body className="d-flex flex-column justify-content-center align-items-center">
                ...
                <Card.Title style={{color: "var(--color3)", fontFamily: 'Verdana, sans-serif'}}>{miembro.nombre}</Card.Title>
                <Card.Text className="text-center" style={{color: "var(--color3)", fontFamily: 'Verdana, sans-serif'}}>{miembro.descripcion}</Card.Text>
              </Card.Body>
            </Card>
          </Col>
        ))}
    ...
    <Row style={{marginTop: '1rem',marginBottom: '1rem'}}>
        ...
        <div className="row">
            <div className="col-sm-12 text-center">
                ...
                <p className="mt-3" style={{ color: "var(--color5)", fontFamily: 'Verdana, sans-serif' }}>
